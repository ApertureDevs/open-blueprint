...
import { IssueCounterComponent } from './issue-counter.component';

describe('IssueCounterComponent', () => {
  let component: IssueCounterComponent;
  let fixture: ComponentFixture<IssueCounterComponent>;

  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [ IssueCounterComponent ],
      schemas: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(IssueCounterComponent);
